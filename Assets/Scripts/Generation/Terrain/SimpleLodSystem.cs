        ...
        void Process(RenderGroup renderer)
        {
            ...
            switch (mode)
            {
                case Mode.Auto:
                    ...
                    bool showHighResDst = renderer.highRes.bounds.SqrDistance(camT.position) <
                                          highResDistanceThreshold * highResDistanceThreshold;
