...
public class LodMeshLoader : MonoBehaviour
{
    ...
    public void Load()
    {
        ...
        Debug.Assert(highResRenderers.Length == lowResRenderers.Length,
            "Mismatch in number of high and low res meshes");
    ...
    MeshRenderer[] CreateRenderers(TextAsset loadFile, Material material)
    {
        ...
        {
            var renderObject = MeshHelper.CreateRendererObject(meshData[i].name, meshData[i], material,
                parent: transform, gameObject.layer);
