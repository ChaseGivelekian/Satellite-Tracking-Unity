...
public class CityLights : MonoBehaviour
{
    ...
    [Header("Debug")] [SerializeField, Disabled]
    Mesh mesh;
    ...
    public void Init(RenderTexture heightMap, Light sunLight)
    {
        ...
        for (int i = 0; i < groups.Length; i++)
        {
            ...
            renderers[i] =
                new CityLightRenderer(bufferOffset, numInstancesInGroup, groups[i].bounds, mesh, instanceShader);
    ...
    public class CityLightRenderer
    {
        ...
        public void Render()
        {
            ...
            Graphics.DrawMeshInstancedIndirect(mesh, 0, material, bounds, renderArgs, camera: null,
                castShadows: shadowMode, receiveShadows: false);
        }
